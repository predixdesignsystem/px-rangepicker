...
describe('Dates', function() {
  ...
  describe('', function() {
    ...
    describe('when from field is clicked', function() {
      ...
      it('opens the left calendar with the to-date month & selected date', function() {
      ...
      it('opens the right calendar with the next month from to-date and NO selected date', function() {
    ...
    describe('when to field is clicked', function() {
      ...
      it('opens the left calendar with the from-date month & selected date', function() {
        expect(leftCalendar.calendar).toEqual([
      ...
      it('opens the right calendar with the next month from from-date and NO selected date', function() {
        expect(rightCalendar.calendar).toEqual([
