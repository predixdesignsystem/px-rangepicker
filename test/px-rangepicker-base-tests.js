...
function runBaseTests() {
  ...
  suite('Base Automation Tests for px-datetime-range-picker', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-datetime-range-picker fixture is created', function() {
      assert.isTrue(document.getElementById('picker') !== null);
    });
